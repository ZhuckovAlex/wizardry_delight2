...
public class ChiefCat extends TamableAnimal implements IAnimatable{
    ...
    private static final Ingredient TEMPT_INGREDIENT = Ingredient.of(InitItemsWD.CHEESE.get(), InitItemsWD.SWEET_ROLL.get(),InitItemsWD.IRIS.get());
    private static final EntityDataAccessor<CatVariant> DATA_VARIANT_ID = SynchedEntityData.defineId(ChiefCat.class, EntityDataSerializers.CAT_VARIANT);
    private static final EntityDataAccessor<Boolean> IS_LYING = SynchedEntityData.defineId(ChiefCat.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> RELAX_STATE_ONE = SynchedEntityData.defineId(ChiefCat.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> DATA_COLLAR_COLOR = SynchedEntityData.defineId(ChiefCat.class, EntityDataSerializers.INT);
    ...
    public ChiefCat(EntityType<? extends ChiefCat> p_28114_, Level p_28115_) {
    ...
    protected void registerGoals() {
        this.temptGoal = new ChiefCat.CatTemptGoal(this, 0.6D, TEMPT_INGREDIENT, true);
        this.goalSelector.addGoal(1, new FloatGoal(this));
//        this.goalSelector.addGoal(1, new SitWhenOrderedToGoal(this));
        this.goalSelector.addGoal(2, new ChiefCat.CatRelaxOnOwnerGoal(this));
    ...
    public ChiefCat getBreedOffspring(ServerLevel p_148870_, AgeableMob p_148871_) {
        return null;
    }
    ...
    static class CatAvoidEntityGoal<T extends LivingEntity> extends AvoidEntityGoal<T> {
        ...
        public CatAvoidEntityGoal(ChiefCat p_28191_, Class<T> p_28192_, float p_28193_, double p_28194_, double p_28195_) {
    ...
    static class CatRelaxOnOwnerGoal extends Goal {
        ...
        public CatRelaxOnOwnerGoal(ChiefCat p_28203_) {
            this.cat = p_28203_;
        }
        ...
        private boolean spaceIsOccupied() {
            for(ChiefCat cat : this.cat.level.getEntitiesOfClass(ChiefCat.class, (new AABB(this.goalPos)).inflate(2.0D))) {
    ...
    static class CatTemptGoal extends TemptGoal {
        ...
        public CatTemptGoal(ChiefCat p_28219_, double p_28220_, Ingredient p_28221_, boolean p_28222_) {
